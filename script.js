...
// const booksCard = document.querySelector(".bookscard");
...
// function formVisable() {
//     if (formOn) {
//         formContainer.style.transform = "scale(0)";
//         newBook.style.transform = "rorate(0)";
//         form.reset();
...
//     pagesNode.innerHTML = `Read?: ${read}${read === "Yes" ? "😃" : "😢"}`;
...
//     booksCard.appendChild(bookNode);
//     formVisable();
//     form.reset();
// }

// //book status update button
...
//     booksCard.removeChild(bookNode);
